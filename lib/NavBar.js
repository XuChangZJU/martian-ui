...
var STATUS_BAR_HEIGHT = Platform.OS === 'ios' ? Dimensions.get('window').height === 812 ? 30 : 20 : 25;
var HEADER_HEIGHT = Platform.OS === 'ios' ? 44 + STATUS_BAR_HEIGHT : 25 + STATUS_BAR_HEIGHT;

var styles = StyleSheet.create({
    header: {
        backgroundColor: 'white',
        // backgroundColor: 'black',
        // 上层引用NavBar时务必将transfluent置为false，使安卓手机上此组件的高定位计算从statusBar下沿开始  by xc 20160930
