...
const STATUS_BAR_HEIGHT = Platform.OS === 'ios' ? (Dimensions.get('window').height === 812 ? 44 : 20) : (StatusBar.currentHeight || 25);
const HEADER_HEIGHT = Platform.OS === 'ios' ? 44 + STATUS_BAR_HEIGHT : 50 + (Platform.Version >= 21 ? STATUS_BAR_HEIGHT : 0);

const styles = StyleSheet.create({
    header: {
        backgroundColor: 'white',
        paddingTop: Platform.OS === 'android' &&  Platform.Version < 21 ? 0 : STATUS_BAR_HEIGHT, //adapt for android 4.3
