...
class MtT0 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
            <Text
                style={[styles.t0,style]}
                {...props}>
            </Text>
        );
    }
...
class MtT1 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
            <Text
                style={[styles.t1,style]}
                {...props}>
            </Text>
        );
    }
...
class MtT7 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
          <Text
            style={[styles.t7,style]}
            {...props}>
          </Text>
        );
    }
...
class MtW1 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
            <Text
                style={[styles.w1,style]}
                {...props}>
            </Text>
        );
    }
...
class MtW5 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
            <Text
                style={[styles.w5,style]}
                {...props}>
            </Text>
        );
    }
...
class MtM5 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
            <Text
                style={[styles.m5,style]}
                {...props}>
            </Text>
        );
    }
...
class MtL1 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
          <Text
            style={[styles.l1,style]}
            {...props}>
          </Text>
        );
    }
...
class MtL6 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
          <Text
            style={[styles.l6,style]}
            {...props}>
          </Text>
        );
    }
...
class MtL7 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
          <Text
            style={[styles.l7,style]}
            {...props}>
          </Text>
        );
    }
...
class MtR7 extends Component {
    render() {
        const {style,...props} =this.props;
        return (
          <Text
            style={[styles.r7,style]}
            {...props}>
          </Text>
        );
    }
